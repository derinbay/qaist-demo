...
public class SmokeTest extends BaseTest {
    ...
    public void shouldLogin() {
        ...
        assertThat("Buyer should be logged in!", new HomePage(driver).isLoggedIn(buyer));
    }
    ...
    public void shouldNotLogin() {
        ...
        assertThat("Buyer should not be logged in!", !new HomePage(driver).isLoggedIn(buyer));
    }
